...
import type { GameRequest, Interaction, JoinRequest, TimeSync } from '@platform/protocol';
import {
...
export class Session {
    ...
    constructor(connectionId: string, identity: string | null, openedAtTick: number) {
