...
/**
 * On every avatar, from the template. `@onCollide` is the ENTER edge and fires once per tag,
 * so an orb walked into scores once however many ticks the two stay touching.
 */
